  ...
  return (
    <div className="bg-primary2 border-3 border-primary4 shop-radius wh-shopsection my-shopsection p-shopsection font-size36 text-primary4 ">
      ...
      <div className="flex items-center">
        <a
          href=""
          className="bg-primary1 border-3 border-primary4 absolute text-center text-uppercase wh-all-box all-box-radius font-size36 all-box-position"
        >
          All
        </a>
        ...
        <Icon
          ...
          width="38"
          height="38"
          className="absolute clock-position "
        />
        <div className="flex items-center gap-4 ml-time text-20px">
          <div className="bg-primary1 border-3 border-primary4  text-center text-uppercase wh-time-box all-box-radius">
            08
          </div>
          <div className="bg-primary1 border-3 border-primary4  text-center text-uppercase wh-time-box all-box-radius">
            23
      ...
      <div className="grid-shop-container shop-container-flex">
        <Link to="/buy">
          <div className="bg-primary5 border-3 border-primary4 shop-box-radius wh-grid-shop-box m-shop-box text-center p-4 cursor-default">
            ...
            <div className="absolute text-24px text2-position">
              Faber-Castell
            </div>
            <div className="absolute text-18px line-through text-discount-position ">
              ฿ 18.00
            </div>
            <div className="absolute text-24px price-position price-color">
              ฿ 9.00
            </div>
            <Icon
              ...
              width="35"
              height="35"
              className="absolute text-primary4 heart-position "
            />
            <Icon
              icon="fluent:cart-20-filled"
              width="38"
              height="38"
              className="absolute text-primary4 cart-position"
            />
          </div>
        </Link>
